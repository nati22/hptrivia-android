 ...
 */
final class PostQuizAuthenticatedAsyncTask extends BasePostRequestAsyncTask<String> {

    private static final String TAG = PostQuizAuthenticatedAsyncTask.class.getSimpleName();
    private static final String uriPrefix = "/users/";
    private static final String uriSuffix = "/quiz/random";

    protected PostQuizAuthenticatedAsyncTask(Context context, String id, List<NameValuePair> parameters) {
